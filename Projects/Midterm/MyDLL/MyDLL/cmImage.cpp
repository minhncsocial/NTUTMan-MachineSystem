...
BOOL  cmImage::Impl::BitBlt(HDC hDestDC,int xDest,int yDest,
                     int nDestWidth,int nDestHeight,
					 int xSrc,int ySrc,DWORD dwROP) 
{
	HDC		hSrcDC;
...
void	cmImage::ReleaseDC()
{
	mImpl->ReleaseDC();
}

BOOL	cmImage::BitBlt(HDC hDestDC,int xDest,int yDest,
                     int nDestWidth,int nDestHeight,
					 int xSrc,int ySrc,DWORD dwROP) 
{
	return (mImpl->BitBlt(hDestDC, xDest, yDest,
